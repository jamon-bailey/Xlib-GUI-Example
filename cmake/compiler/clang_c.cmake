...
set(X11_GUI_CLANG_C_VERSION_MIN 14 CACHE STRING "Minimum clang compiler version")

# Confirm supported clang compiler version
if(CMAKE_C_COMPILER_VERSION VERSION_LESS ${X11_GUI_CLANG_C_VERSION_MIN})
    message(FATAL_ERROR "Incompatible version of Clang C compiler for ${CMAKE_PROJECT_NAME}.")
endif()

# Compiler feature configuration target
add_library(X11_GUI_clang_c_features INTERFACE)
# Compiler diagnostics configuration target
add_library(X11_GUI_clang_c_warnings INTERFACE)
# General compiler configuration target
add_library(X11_GUI_clang_c_options INTERFACE)
# Preprocessor definitions target
add_library(X11_GUI_clang_c_defines INTERFACE)

# Set C standard version
target_compile_features(
    X11_GUI_clang_c_features
...
add_library(X11_GUI_clang_c_bundle INTERFACE)

target_link_libraries(
    X11_GUI_clang_c_bundle
